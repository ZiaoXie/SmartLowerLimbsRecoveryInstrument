...
public class DataBaseHelper {
    ...
    public static String path="http://10.120.51.105:8080/PDS";//Tomcat
//    private final static String path="http://10.120.51.105:8000"; //Django
//    public static String path="http://192.168.1.103:8080/PDS";//滨海家庭
//    private final static String path="http://192.168.100.8:8080/PDS";//枫桥雅筑
...
//            URL url = new URL(path+"/SmartYangSheng/Django/QueryByBean");//Django
    ...
    public static List Query(int n,String[] params,Class targetClass,String SQL){

        String line = null;
        StringBuilder sb = new StringBuilder();
        try {
            URL url = new URL(path+"/servlet/QueryByBeanEasy");//Tomcat
//            URL url = new URL(path+"/SmartYangSheng/Django/QueryByBean");//Django
            ...
            data+=("&SQL="+URLEncoder.encode(SQL, "UTF-8"));
            // 设置请求的头
            urlConnection.setRequestProperty("Connection", "keep-alive");
            // 设置请求的头
            urlConnection.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
